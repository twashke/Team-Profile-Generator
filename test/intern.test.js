...
describe("Intern", () => {
    it("Sets the intern school using constructor function", () => {
        ...
        const newIntern = new Intern("Alice", 200, "random@test.com", newSchool);
...
describe("getSchool", () => {
    it("Gets school when getSchool function is called", () => {
        ...
        const newIntern = new Intern("Alice", 200, "random@test.com", internSchool);
...
describe("getRole", () => {
    it("Gets intern role when getRole function is called", () => {
        ...
        const newIntern = new Intern("Alice", 200, "random@test.com", "UW Coding Bootcamp");
