...
describe("Manager", () => {
    it("Sets the manager office number using constructor function", () => {
        ...
        const newManager = new Manager("Emily", 200, "random@test.com", newOfficeNumber);
...
describe("getOfficeNumber", () => {
    it("Gets office number when getOfficeNumber function is called", () => {
        ...
        const newManager = new Manager("Emily", 200, "random@test.com", managerNumber);
...
describe("getRole", () => {
    it("Gets manager role when getRole function is called", () => {
        ...
        const newManager = new Manager("Emily", 200, "random@test.com", "(555)867-5309");
